...
export const metadata: Metadata = {
    title: "Professional Translation Services in Islamabad | Certified & Legal",
...
export default function IslamabadTranslationPage() {
    return (
        <main className="min-h-screen bg-[#fcfdfe] font-sans">
            {/* Custom Hero with Immediate CTAs (DA1 Rule: CTAs above the fold) */}
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-4xl mx-auto text-center">
                        <span className="inline-block py-1 px-3 rounded-full bg-emerald-800/50 border border-emerald-700 text-emerald-300 text-xs font-bold tracking-widest uppercase mb-6">
                            Lisan.pk Islamabad Hub
                        </span>
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6 leading-tight capitalize">
                            Translation services in islamabad
                        </h1>
                        <p className="text-lg md:text-xl text-emerald-100/80 mb-10 max-w-2xl mx-auto leading-relaxed">
                            Serving corporate clients across Blue Area, F-8 Markaz, and the Diplomatic Enclave. We provide official document translation and linguistic experts for all major embassies.
                        </p>
                        
                        {/* High-Visibility CTAs */}
                        <div className="flex flex-col sm:flex-row justify-center gap-4">
                            <Link href="https://wa.me/923044296295?text=Hi%20Lisan.pk,%20I%20need%20translation%20services%20in%20Islamabad." target="_blank" className="w-full sm:w-auto">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="space-y-8">
                            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 leading-tight">
                                Top-Rated Urdu Translation Islamabad
                            </h2>
                            <p className="text-slate-600 text-lg leading-relaxed">
                                Whether you're a business operating out of the Centaurus Corporate Tower or an individual applying for a visa at the US Embassy Pakistan Islamabad, our certified document translation meets the strictest international standards. We are the leading provider of Islamabad translation services.
                            </p>
                            <ul className="space-y-4">
                                {[
                                    "Embassy-Approved Legal Translation",
                                    "Rapid Turnaround for Urgent Deadlines",
                                    "Secure Doorstep Courier in Islamabad & Rawalpindi",
                                    "MOFA & HEC Attestation Support"
                                ].map((item, i) => (
                        ...
                        <div className="bg-white p-8 md:p-10 rounded-[2.5rem] border border-slate-100 shadow-2xl shadow-emerald-900/5">
                            <h3 className="text-2xl font-bold text-slate-900 mb-6">Our Process for Capital Residents</h3>
                            <div className="space-y-6">
                                <div className="border-l-2 border-emerald-500 pl-6 relative">
                                    ...
                                    <h4 className="font-bold text-slate-900 mb-2">1. Send Documents Digitally</h4>
                                    <p className="text-slate-600 text-sm">Send clear photos or scans of your documents via our WhatsApp line for an instant quote.</p>
                                </div>
                                <div className="border-l-2 border-emerald-500 pl-6 relative">
                                    <div className="absolute w-3 h-3 bg-emerald-500 rounded-full -left-[7px] top-1.5"></div>
                                    <h4 className="font-bold text-slate-900 mb-2">2. Certified Translation</h4>
                                    <p className="text-slate-600 text-sm">Our linguistic experts process your documents, ensuring absolute accuracy and legal compliance.</p>
                                </div>
                                <div className="border-l-2 border-slate-200 pl-6 relative">
                                    ...
                                    <p className="text-slate-600 text-sm">We courier the final, stamped physical documents to your home or office anywhere in Islamabad.</p>
                                </div>
                            </div>
                        </div>
                    </div>
