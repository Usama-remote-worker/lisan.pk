...
import { CheckCircle2, GraduationCap, ExternalLink, ShieldCheck, Phone } from "lucide-react"
            ...
            <section className="py-20 bg-emerald-950 text-white relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-500/10 text-emerald-400 rounded-full text-[10px] font-bold uppercase tracking-[0.2em] mb-8 border border-emerald-500/20">
                        <GraduationCap className="w-4 h-4" /> Fully Funded Scholarship Guide 2026
                    </div>
                    ...
                    <p className="text-xl text-emerald-50/70 max-w-3xl mx-auto leading-relaxed mb-8">
                        {university.description}
                    </p>
                    <div className="flex flex-wrap justify-center gap-3 mb-4">
                        {university.tags.map(tag => (
                            <span key={tag} className="px-3 py-1 bg-emerald-500/20 text-emerald-300 rounded-full text-xs font-bold border border-emerald-500/30">{tag}</span>
                        ))}
                        <span className="px-3 py-1 bg-emerald-500/20 text-emerald-300 rounded-full text-xs font-bold border border-emerald-500/30">📍 {university.location}</span>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 container mx-auto px-4 max-w-7xl">
                <div className="grid lg:grid-cols-3 gap-16">
                    <div className="lg:col-span-2 space-y-12">
                        ...
                        {/* Body Content */}
                        <div className="prose prose-slate prose-lg max-w-none prose-headings:font-bold prose-headings:text-slate-900 prose-strong:text-slate-900 prose-p:text-slate-600 prose-p:leading-relaxed">
                        ...
                        <div className="p-8 bg-emerald-50 rounded-[2rem] border border-emerald-100">
                            <h3 className="text-2xl font-bold text-emerald-900 mb-4">Official Application Portal</h3>
                    ...
                    <div className="space-y-8 lg:sticky lg:top-28 h-fit">
                        <div className="p-8 bg-slate-900 text-white rounded-[2rem] shadow-2xl">
                            ...
                            <h3 className="text-2xl font-bold mb-4 font-serif">How Lisan.pk Helps</h3>
                            ...
                            <Link href="tel:+923044296295" className="block">
                                <Button variant="outline" className="w-full h-12 rounded-xl border-slate-700 text-slate-300 hover:bg-slate-800 font-bold">
                                    <Phone className="w-4 h-4 mr-2" /> 03044296295
                                </Button>
                            </Link>
                        </div>
