        ...
        <section className="relative bg-slate-50 py-20 lg:py-32 overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="max-w-4xl mx-auto text-center">
                    <div className="inline-flex items-center rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-sm font-medium text-emerald-800 mb-6 shadow-sm">
                        <span className="flex h-2 w-2 rounded-full bg-emerald-600 mr-2 animate-pulse"></span>
                        Embassy Recommended Services
                    </div>
                    <h1 className="text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl lg:text-7xl mb-6">
                        Pakistan’s #1 <span className="text-emerald-600">Arabic Translation</span> Service
                    </h1>
                    <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-2xl mx-auto leading-relaxed">
                        Trusted by 100k+ clients for over 30 years. We provide accurate, certified translation and attestation services with doorstep delivery across Pakistan.
                    </p>
